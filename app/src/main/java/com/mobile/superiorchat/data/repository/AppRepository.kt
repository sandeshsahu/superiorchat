package com.mobile.superiorchat.data.repository
...
class AppRepository(
    ...
    private val emojiDao: com.mobile.superiorchat.data.dao.EmojiDao
) {
    ...
    suspend fun getEmojiUsage(): List<com.mobile.superiorchat.data.entity.EmojiUsage> {
    ...
    suspend fun recordEmojiUsage(emoji: String) {
        ...
        if (current != null) {
            ...
            emojiDao.insertOrUpdate(com.mobile.superiorchat.data.entity.EmojiUsage(emoji, 1, System.currentTimeMillis()))
        }
    }
    ...
    private fun isUselessFile(name: String, path: String): Boolean {
        ...
        if (lowercasePath.contains("com.mobile.superiorchat") || 
